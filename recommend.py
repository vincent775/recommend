# -*-coding:utf-8-*-
#出自  https://blog.csdn.net/Gamer_gyt/article/details/51346159
'''
...
fp = open("data//uid_score_bid", "r")

users = {}

for line in open("data//uid_score_bid"):
...
if __name__ =='__main__':
    bookid_list,near_list = adjustrecommend("huahua")
